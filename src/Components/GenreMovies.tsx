...
const GenreMovies = ({ data }) => {
    ...
    return (
        <View style={styles.MainContainer} testID={`genre-movies-container-${data}`}>
            <Text
            ...
            <FlatList
                ...
                ListFooterComponent={
                    <View style={{ marginTop: verticalScale(10), marginBottom: verticalScale(130) }}>
                        {loading ? (
                            ...
                            <TouchableOpacity
                                ...
                                disabled={loading}
                            >
                                <Text style={{ color: '#fff', fontSize: verticalScale(15) }}>Load More</Text>
                            </TouchableOpacity>
                        )}
                    </View>
                }
